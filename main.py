...
def display_intro():
    print(
        """In this game, each player is allowed a maximum of 5 guesses.
        You will be playing against the computer. Do not worry, I have
        access to a limited number of words. In the future, I will have
          access to all words of the English language"""
    )
    ...
    print(
        """In this game, you can choose between four categories.
        The categories available are "fruits", "places", and "animals".
        If you up to the challenge, choose "expert" """
    )
